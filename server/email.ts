...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f7; margin: 0; padding: 20px;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <div style="background: linear-gradient(135deg, #1A5299 0%, #2563eb 100%); padding: 30px; text-align: center;">
      <h1 style="color: #ffffff; margin: 0; font-size: 24px;">📖 Bíblia Hebraico & Grego</h1>
    </div>
    <div style="padding: 30px;">
      <h2 style="color: #1A5299; margin-top: 0;">Olá${userName ? `, ${userName}` : ''}!</h2>
      <p style="color: #4a5568; line-height: 1.6;">Você solicitou a recuperação de senha da sua conta. Clique no botão abaixo para criar uma nova senha:</p>
      ...
      <p style="color: #a0aec0; font-size: 12px;">⏰ Este link expira em <strong>1 hora</strong>.</p>
      <p style="color: #a0aec0; font-size: 12px;">Se você não solicitou esta recuperação, ignore este email.</p>
    </div>
    <div style="background-color: #f7fafc; padding: 20px; text-align: center;">
      <p style="color: #a0aec0; font-size: 12px; margin: 0;">Bíblia Hebraico & Grego - Estudo Bíblico com IA</p>
    </div>
  </div>
</body>
</html>
