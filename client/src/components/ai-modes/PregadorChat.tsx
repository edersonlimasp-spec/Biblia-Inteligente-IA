    ...
    <div className="h-screen bg-gradient-to-b from-purple-950/20 to-background flex flex-col overflow-hidden">
      ...
      <ScrollArea className="flex-1" ref={scrollRef}>
        <div className="max-w-4xl mx-auto p-4 space-y-4 pb-4">
          {/* Sermon inspirations when no messages */}
          {messages.length === 0 && (
            <>
                  ...
                  >
                    <CardContent className="p-3 flex items-center gap-2">
                      ...
                      <div className="min-w-0">
                        <p className="text-[10px] text-purple-600 dark:text-purple-400 font-medium">{item.category}</p>
              ...
              <Card className="bg-gradient-to-br from-purple-50 to-purple-100/50 dark:from-purple-950/30 dark:to-purple-900/20 border-purple-200/50">
                <CardContent className="p-4 text-center">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center mx-auto mb-3 shadow-lg shadow-purple-500/30">
                    <Church className="w-7 h-7 text-white" />
                  </div>
                  <h2 className="text-lg font-semibold mb-1">Seu Assistente de Pregação</h2>
                  <p className="text-sm text-muted-foreground max-w-md mx-auto">
                    Crie sermões inspiradores, esboços de mensagens e ilustrações.
                  </p>
                </CardContent>
              </Card>
            </>
